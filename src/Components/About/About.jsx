...
import profileImage from '../../MyPhoto/anas.jpeg'
    ...
    <section id='about' className='py-4 px-[7vw] md:px-[7vw] lg:px-[10vw] font-sans mt-16 md:mt-24 lg:mt-32'>
      <div className='flex flex-col-reverse md:flex-row  justify-between items-center'>
        ...
        <div className='md:w-1/2 text-center mr-auto md:text-left mt-8 md:mt-20'>
          ...
          <h2 className='text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-tight'>Anas Khan</h2>
          ...
          <a href="https://drive.google.com/file/d/1VRW5NE4BAg7Hw6POtyLvRaAIntM-q_ro/view?usp=sharing"
            target='_blank'
        ...
        <div className=' md:w-1/2 flex  justify-center md:justify-end mt-6'>
          <Tilt
            ...
            gyroscope={true}
          >
            <img src={profileImage} alt="Anas Khan"
